...
BLOG_AUTHOR = "龙龙"  # (translatable)
BLOG_TITLE = "龙龙的程序设计课堂"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://teacherlonglong.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://teacherlonglong.github.io/"
BLOG_EMAIL = "teacherlonglong@126.com"
BLOG_DESCRIPTION = "因为知道的太少，所以想学的太多。"  # (translatable)
...
(function() {
  ...
  hm.src = "https://hm.baidu.com/hm.js?b320d6857521bb51b7a00bd6742175a5";
